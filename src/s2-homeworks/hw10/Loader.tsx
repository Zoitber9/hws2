...
export const Loader = () => <div className={s.loader}>
    <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <radialGradient id="paint0_angular_4_64" cx=".1" cy=".1" r="1.3" fx='.4' fy='.9'  gradientUnits="userSpaceOnUse" gradientTransform="translate(10 90) scale(120)">
                <stop offset="0" stop-color="#f5e5df"/>
                <stop offset=".25" stop-color="#efbeac"/>
                <stop offset=".5" stop-color="#ea997a"/>
                <stop offset=".75" stop-color="#8971e8"/>
